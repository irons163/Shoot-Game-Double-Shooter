...
public class GravityInverseAngelMovementInfoAppendDecorator extends MovementDecorator{
	...
	private MovementActionInfo coreCalculationMovementActionInfo(
		...
		MovementActionInfo newInfo = new MovementActionInfo(info.getTotal(), info.getDelay(), info.getDx(), info.getDy(), info.getDescription(), info.isEnableGravity());
...
////			newInfo.setRotationController().setRotation(-info.getRotationController().getRotation());
