...
public class Circle22Controller implements IRotationController{
	...
	public Circle22Controller(float rotation, float x, float y, float mx, float my) {
	...
	public Circle22Controller(float rotation, float x, float y, float mx, float my, Circle22Controller rotationController) {
		this.rotation = rotation;
		this.x = x;
		this.y =y;
		this.mx = mx;
