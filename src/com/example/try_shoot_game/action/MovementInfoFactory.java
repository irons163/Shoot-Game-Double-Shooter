...
import com.example.try_shoot_game.GameView;
...
//		MovementActionInfo right = new MovementActionInfo(24000, 100, 30, 0, "R", new Circle2Controller(10, 400, 700, 450, 750));
//		GameView.circleController1 = (Circle2Controller) right.getRotationController();
//		return right;
//	}
//	
//	public static MovementActionInfo createSubCircleMovementInfo(){
//		MovementActionInfo right = new MovementActionInfo(24000, 100, 30, 0, "R", new Circle2Controller(10, 450, 750, 500, 800));
//		GameView.circleController2 = (Circle2Controller) right.getRotationController();
//		return right;
//	}
	
	public static MovementActionInfo create2CircleMovementInfo(){
		MovementActionInfo right = new MovementActionInfo(24000, 200, 30, 0, "R", new Circle22Controller(5, 400, 700, 450, 750));
	...
	public static MovementActionInfo create2SubCircleMovementInfo(){
		MovementActionInfo right = new MovementActionInfo(24000, 50, 30, 0, "R", new Circle22Controller(-10, 450, 750, 500, 800));
