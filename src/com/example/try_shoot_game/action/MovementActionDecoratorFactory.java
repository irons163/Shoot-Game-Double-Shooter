...
//	public static List<List<Class<? extends MovementDecorator>>> createMovementItemDecorator(){
//		List<List<Class<? extends MovementDecorator>>> decoratorClassLists = new ArrayList<List<Class<? extends MovementDecorator>>>();
//		decoratorClassList.add(DoubleDecorator.class);
//		decoratorClassList.add(HalfDecorator.class);
//		return decoratorClassList;
//	}
